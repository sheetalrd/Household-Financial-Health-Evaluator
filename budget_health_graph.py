...
# ----------------------------------------------------------------------
# State management class for household financial data. This class holds all the
# relevant financial information and analysis results as the data flows through. 
# It contains the household financial data and results generated by the graph.
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# Nodes - Each function represents a node in the graph. The project has three specialist analysis nodes.
# Each node has one responsibility: analyze cash flow, debt pressure, or savings readiness. Each node uses the LLM to generate an analysis based on the household financial data.
# ----------------------------------------------------------------------    
...
# ----------------------------------------------------------------------
# Parallel execution - All three specialist analysis start from START and run in parallel.
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# Fan-in - All three specialist analyses feed into the classify_budget_health node, which waits for all three to complete before proceeding.
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# Conditional edges - Based on the classification result, the graph routes to either a stable budget plan or a recovery plan.
# ----------------------------------------------------------------------
